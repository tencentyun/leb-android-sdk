...
package com.tencent.xbright.lebwebrtcdemo.utils;
...
public class AsyncHttpURLConnection {
  ...
  public AsyncHttpURLConnection(String method, String url, String message, AsyncHttpEvents events) {
    ...
    this.events = events;
    this.origin = HTTP_ORIGIN;
  }

  public AsyncHttpURLConnection(String method, String url, String message, String origin, String ctype, AsyncHttpEvents events) {
    this.method = method;
    this.url = url;
    this.message = message;
    this.events = events;
